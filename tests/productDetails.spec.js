...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.ok(productDetails(productDetails.details)[0].details.productId.endsWith('123'));
    assert.ok(productDetails(productDetails.details)[1].details.productId.endsWith('123'));
  });
});
