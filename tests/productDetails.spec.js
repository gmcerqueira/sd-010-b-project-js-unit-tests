...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const trueFalse = (productDetails()[0].details.productId.includes('123'));
    const trueFalse1 = (productDetails()[1].details.productId.includes('123'));
    assert.strictEqual((trueFalse && trueFalse1), true);
  });
});
