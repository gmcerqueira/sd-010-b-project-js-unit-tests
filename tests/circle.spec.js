...
describe('#circle', () => {
  it('given a radius, should return an object with circles info', () => {
    ...
    let array = Object.entries(circle(3));

    assert.deepStrictEqual(typeof circle(1), 'object');
    let output = Object.keys(circle(1));
    assert.deepStrictEqual((output.length), 3);
    ...
    output = array[1][1];
    assert.deepStrictEqual(Number(parseFloat(circle(3).area).toPrecision(4)), 28.26);
