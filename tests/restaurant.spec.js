...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(restaurant.fetchMenu(), objMenu);
    // --------------------------------------------------------------------------------------
    ...
    // ```
    const objetoRetornado5 = createMenu(objMenu);
    ...
    objetoRetornado5.order('cerveja');

    assert.deepStrictEqual(objetoRetornado5.consumption, ['coxinha', 'agua', 'sopa', 'cerveja']);
    ...
    // ```
    let somaDosPreçosDosPedidos = 39.93;
