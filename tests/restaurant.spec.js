...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    // const objetoRetornado = createMenu({ food:clea {}, drink: {} });
    // objetoRetornado.fetchMenu() // Retorno: { food: {}, drink: {}}
    // createMenu({ food: {}, drink: {} });

    const teste2 = Object.keys(objetoRetornado.fetchMenu());
    ...
    assert.deepStrictEqual(teste3, objetoRetornado.fetchMenu());
    ...
    // como `objetoRetornado.order('coxinha')`, tal string é adicionada ao array retornado em `
