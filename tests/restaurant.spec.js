...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    let stringArray = Object.keys(objetoRetornado).toString();
    assert.deepStrictEqual(stringArray.includes('fetchMenu'), true);
    ...
    // ```
    stringArray = Object.keys(objetoRetornado.fetchMenu());
    assert.deepStrictEqual(stringArray, ['food', 'drink']);
    ...
    assert.deepStrictEqual(parseFloat(objetoRetornado.pay().toFixed(2)), 12.87);
  });
});
