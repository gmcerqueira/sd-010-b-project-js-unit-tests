...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    assert.deepStrictEqual(createMenu({drink: 'Coca-Cola'}).fetchMenu(), {drink: 'Coca-Cola'});
    ...
    menu3.order('sopa');
    menu3.order('sashimi');
    assert.deepStrictEqual(menu3.consumption, ['coxinha', 'coxinha', 'sopa', 'sashimi']);
    ...
    menu4.order('agua');
    menu4.order('coxinha');
    assert.deepStrictEqual(menu4.pay(), 10.89);
