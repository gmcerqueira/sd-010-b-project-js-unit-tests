...
+  it('tests the function has the correct behaviour', () => {
    ...
    const array = [typeof objetoRetornado, Object.hasOwnProperty.call(objetoRetornado, 'fetchMenu'), typeof objetoRetornado.fetchMenu];
    const xablau = ['object', true, 'function'];
    assert.deepStrictEqual(array, xablau);
    ...
    const retornoFetchMenu = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    assert.deepStrictEqual({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} }, retornoFetchMenu.fetchMenu());
    ...
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    assert.deepStrictEqual(objetoRetornado.pay(), (3.9 + 3.9 + 3.9) * 1.1);
