...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const array = [ typeof objetoRetornado, typeof objetoRetornado.fetchMenu,
      Object.hasOwnProperty.call( objetoRetornado, 'fetchMenu' )];
    const xablau = [ 'object', 'function', true ];
    ...
    const retornoFetchMenu = createMenu ({
      food: {
        'coxinha': 3.9,
        'sopa': 9.9
      },
