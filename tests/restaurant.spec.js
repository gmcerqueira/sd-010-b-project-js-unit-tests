...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const objetoRetornado1 = createMenu({ cats: {}, dogs: {}, birds: {}, fish: {} });
    // objetoRetornado.fetchMenu() // Retorno: objetoQualquer
    // ```
    assert.deepStrictEqual(objetoRetornado1.fetchMenu(), { cats: {}, dogs: {}, birds: {}, fish: {} });
    // Agora faça o PASSO 1 no arquivo `src/restaurant.js`.
    // --------------------------------------------------------------------------------------
    // TESTE 4: Verifique que 'objetoRetornado.consumption', após a criação do menu, retorna um array vazio.
    // ```
    const objetoRetornado2 = createMenu({ cats: {}, dogs: {}, birds: {}, fish: {} });
    ...
    // ```
    const objetoRetornado3 = createMenu({ cats: {}, dogs: {}, birds: {}, fish: {} });
    ...
    objetoRetornado5.order('coxinha');
    // objetoRetornado5.comsuption // Retorno: ['coxinha', 'agua', 'coxinha']
    // ```
    ...
    assert.strictEqual(meuRestaurante.pay(), 1.10 * (obj.food.coxinha + obj.food.sopa + obj.drink.agua));
