...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.notStrictEqual(createMenu().fetchMenu, undefined);
    ...
    assert.deepStrictEqual(objetoRetornado.fetchMenu(), { food: {}, drinks: {} });
    // ```
    ...
    // ```
    assert.strictEqual(objetoRetornado.cosumption, []);
    ...
    // ```
    const sumTotal = parseFloat(((3.9 + 3.9 + 3.9) * 1.1).toPrecision(4));
    assert.strictEqual(objetoRetornado.pay(), sumTotal);
    // ```
